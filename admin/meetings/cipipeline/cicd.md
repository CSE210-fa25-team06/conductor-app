...
During review we check more than correctness. We look at whether the code is written in a clear way and whether the file structure and file names follow the project guidelines. We also check that any new feature is documented in the correct place so future developers understand what it does. Reviewers also point out design concerns and catch small details that automated tools cannot see. This keeps our main branch stable and readable as the project grows.
